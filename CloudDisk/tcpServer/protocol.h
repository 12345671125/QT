...
protocol::PDU* createPDU(uint uiMsgLen);
protocol::FileInfoList* createFileInfoList(int length);
protocol::FileInfo createFileInfo(const int iFileType,const char* caFileName,const qint64 FileSize);
