...
#ifdef Q_OS_WIN
WindowsDXGIDuplication::WindowsDXGIDuplication():
    m_DeskDupl(nullptr),
...
bool WindowsDXGIDuplication::InitDevice()
{
    HRESULT hr = S_OK;
...
bool WindowsDXGIDuplication::InitDuplication(UINT Output)
{
...
bool WindowsDXGIDuplication::getFrame(int timeout)
{
...
bool WindowsDXGIDuplication::copyFrameToBuffer(uint8_t* buffer,int bufferSize,int& width,int& height)
{
    HRESULT hr;
...
bool WindowsDXGIDuplication::DoneWithFrame()
{
