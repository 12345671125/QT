...
static constexpr auto qt_meta_stringdata_CLASSIndexWidgetENDCLASS = QtMocHelpers::stringData(
    "IndexWidget"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSIndexWidgetENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSIndexWidgetENDCLASS_t qt_meta_stringdata_CLASSIndexWidgetENDCLASS = {
    {
        QT_MOC_LITERAL(0, 11)   // "IndexWidget"
    },
    "IndexWidget"
};
