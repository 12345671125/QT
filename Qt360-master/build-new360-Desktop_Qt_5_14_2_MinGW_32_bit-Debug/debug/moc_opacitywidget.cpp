...
#include <memory>
#include "../../Qt360-master/src/main/common/opacitywidget.h"
...
void OpacityWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<OpacityWidget *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject OpacityWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_OpacityWidget.data,
    qt_meta_data_OpacityWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
