...
#include <memory>
#include "../../Qt360-master/src/commom/staticbutton.h"
...
void StaticButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<StaticButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (StaticButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StaticButton::buttonClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (StaticButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StaticButton::enterSignal)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (StaticButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StaticButton::leaveSignal)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject StaticButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_StaticButton.data,
    qt_meta_data_StaticButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
