...
#include <memory>
#include "../../Qt360-master/src/commom/dynamicbutton.h"
...
void DynamicButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DynamicButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (DynamicButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DynamicButton::buttonClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (DynamicButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DynamicButton::firstFinished)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DynamicButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_DynamicButton.data,
    qt_meta_data_DynamicButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
