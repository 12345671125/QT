...
#include <memory>
#include "../../Qt360-master/src/main/top/topbottomwidget.h"
...
void TopBottomWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TopBottomWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (TopBottomWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TopBottomWidget::payinsureClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TopBottomWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TopBottomWidget::securityClicked)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (TopBottomWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TopBottomWidget::examineClicked)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (TopBottomWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TopBottomWidget::viewClicked)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject TopBottomWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_TopBottomWidget.data,
    qt_meta_data_TopBottomWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
