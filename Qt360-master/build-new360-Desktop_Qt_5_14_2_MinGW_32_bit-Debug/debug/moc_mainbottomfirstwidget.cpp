...
#include <memory>
#include "../../Qt360-master/src/main/bottom/mainbottomfirstwidget.h"
...
void MainBottomFirstWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MainBottomFirstWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (MainBottomFirstWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainBottomFirstWidget::safeClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MainBottomFirstWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainBottomFirstWidget::cleanClicked)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MainBottomFirstWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainBottomFirstWidget::youhuaClicked)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (MainBottomFirstWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainBottomFirstWidget::advtoolMoreClicked)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MainBottomFirstWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<BaseStyleWidget::staticMetaObject>(),
    qt_meta_stringdata_MainBottomFirstWidget.data,
    qt_meta_data_MainBottomFirstWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
