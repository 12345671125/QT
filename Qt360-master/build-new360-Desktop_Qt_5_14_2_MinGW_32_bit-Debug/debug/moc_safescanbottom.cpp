...
#include <memory>
#include "../../Qt360-master/src/safe/common/safescanbottom.h"
...
void SafeScanBottom::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SafeScanBottom *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SafeScanBottom::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SafeScanBottom::quickClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SafeScanBottom::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SafeScanBottom::fullClicked)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SafeScanBottom::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SafeScanBottom::customClicked)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (SafeScanBottom::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SafeScanBottom::fixClicked)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (SafeScanBottom::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SafeScanBottom::patchClicked)) {
                *result = 4;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SafeScanBottom::staticMetaObject = { {
    QMetaObject::SuperData::link<BaseStyleWidget::staticMetaObject>(),
    qt_meta_stringdata_SafeScanBottom.data,
    qt_meta_data_SafeScanBottom,
    qt_static_metacall,
    nullptr,
    nullptr
} };
