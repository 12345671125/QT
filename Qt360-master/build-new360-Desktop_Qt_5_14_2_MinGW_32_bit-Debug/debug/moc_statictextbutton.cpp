...
#include <memory>
#include "../../Qt360-master/src/commom/statictextbutton.h"
...
void StaticTextButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<StaticTextButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (StaticTextButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StaticTextButton::buttonClicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject StaticTextButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_StaticTextButton.data,
    qt_meta_data_StaticTextButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
