...
#include <memory>
#include "../../Qt360-master/src/main/top/mainscorewidget.h"
...
void MainScoreWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MainScoreWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (MainScoreWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainScoreWidget::cancleExamine)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MainScoreWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainScoreWidget::oneFix)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MainScoreWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainScoreWidget::reExamine)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MainScoreWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_MainScoreWidget.data,
    qt_meta_data_MainScoreWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
