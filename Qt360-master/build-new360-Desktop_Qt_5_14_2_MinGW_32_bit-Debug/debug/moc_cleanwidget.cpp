...
#include <memory>
#include "../../Qt360-master/src/clean/cleanwidget.h"
...
void CleanWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CleanWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (CleanWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CleanWidget::goToMain)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CleanWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CleanWidget.data,
    qt_meta_data_CleanWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
