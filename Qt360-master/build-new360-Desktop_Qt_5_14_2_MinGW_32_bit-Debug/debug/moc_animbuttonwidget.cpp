...
#include <memory>
#include "../../Qt360-master/src/commom/animbuttonwidget.h"
...
void AnimButtonWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AnimButtonWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject AnimButtonWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_AnimButtonWidget.data,
    qt_meta_data_AnimButtonWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
