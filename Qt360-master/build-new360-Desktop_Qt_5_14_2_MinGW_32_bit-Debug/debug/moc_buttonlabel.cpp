...
#include <memory>
#include "../../Qt360-master/src/main/common/buttonlabel.h"
...
void ButtonLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ButtonLabel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ButtonLabel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ButtonLabel::labelClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ButtonLabel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ButtonLabel::enterSignal)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ButtonLabel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ButtonLabel::leaveSignal)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ButtonLabel::staticMetaObject = { {
    QMetaObject::SuperData::link<QLabel::staticMetaObject>(),
    qt_meta_stringdata_ButtonLabel.data,
