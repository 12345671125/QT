...
#include <memory>
#include "../../Qt360-master/src/commom/dynamicwidget.h"
...
QT_MOC_LITERAL(1, 14, 12), // "animFinished"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 15), // "updateClockwise"
QT_MOC_LITERAL(4, 44, 22) // "updateCounterclockwise"

    },
    "DynamicWidget\0animFinished\0\0updateClockwise\0"
...
void DynamicWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->updateClockwise(); break;
        case 2: _t->updateCounterclockwise(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DynamicWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DynamicWidget::animFinished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DynamicWidget::animFinished()
{
