...
#include <memory>
#include "../../Qt360-master/src/safe/safewidget.h"
...
void SafeWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SafeWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SafeWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SafeWidget::goToMain)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SafeWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_SafeWidget.data,
    qt_meta_data_SafeWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
