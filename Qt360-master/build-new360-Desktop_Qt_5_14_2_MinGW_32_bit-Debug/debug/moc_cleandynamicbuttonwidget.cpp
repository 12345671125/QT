...
#include <memory>
#include "../../Qt360-master/src/clean/common/cleandynamicbuttonwidget.h"
...
void CleanDynamicButtonWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CleanDynamicButtonWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (CleanDynamicButtonWidget::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CleanDynamicButtonWidget::checkedChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CleanDynamicButtonWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CleanDynamicButtonWidget.data,
    qt_meta_data_CleanDynamicButtonWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
