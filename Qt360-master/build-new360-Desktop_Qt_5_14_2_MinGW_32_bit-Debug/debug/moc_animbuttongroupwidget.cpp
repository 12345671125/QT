...
#include <memory>
#include "../../Qt360-master/src/commom/animbuttongroupwidget.h"
...
void AnimButtonGroupWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AnimButtonGroupWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (AnimButtonGroupWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AnimButtonGroupWidget::turnPage)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AnimButtonGroupWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AnimButtonGroupWidget::leaveButtonSignal)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (AnimButtonGroupWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AnimButtonGroupWidget::setOriginSignal)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (AnimButtonGroupWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AnimButtonGroupWidget::setEndSignal)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AnimButtonGroupWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_AnimButtonGroupWidget.data,
    qt_meta_data_AnimButtonGroupWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
