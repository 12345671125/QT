...
#include <memory>
#include "../../Qt360-master/src/main/common/backgroundbutton.h"
...
void BackgroundButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<BackgroundButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (BackgroundButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BackgroundButton::buttonClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (BackgroundButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BackgroundButton::enterSignal)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (BackgroundButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BackgroundButton::leaveSignal)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject BackgroundButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_BackgroundButton.data,
    qt_meta_data_BackgroundButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
