...
#include <memory>
#include "../../Qt360-master/src/commom/sysbuttongroup.h"
...
void SysButtonGroup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SysButtonGroup *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SysButtonGroup::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SysButtonGroup::playVideo)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SysButtonGroup::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SysButtonGroup::showSkin)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SysButtonGroup::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SysButtonGroup::showMenu)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (SysButtonGroup::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SysButtonGroup::showMin)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (SysButtonGroup::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SysButtonGroup::closeWidget)) {
                *result = 4;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SysButtonGroup::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_SysButtonGroup.data,
    qt_meta_data_SysButtonGroup,
    qt_static_metacall,
    nullptr,
    nullptr
} };
