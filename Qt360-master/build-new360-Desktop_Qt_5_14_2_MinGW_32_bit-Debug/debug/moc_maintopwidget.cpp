...
#include <memory>
#include "../../Qt360-master/src/main/maintopwidget.h"
...
void MainTopWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MainTopWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (MainTopWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainTopWidget::playVideo)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MainTopWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainTopWidget::showSkin)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MainTopWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainTopWidget::showMenu)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (MainTopWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainTopWidget::showMin)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (MainTopWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainTopWidget::closeWidget)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (MainTopWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainTopWidget::goExamine)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (MainTopWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainTopWidget::goMain)) {
                *result = 6;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MainTopWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<BaseStyleWidget::staticMetaObject>(),
    qt_meta_stringdata_MainTopWidget.data,
    qt_meta_data_MainTopWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
